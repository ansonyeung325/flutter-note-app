...
class ATextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelLarge: TextStyle().copyWith(fontSize: 12,fontWeight: FontWeight.w500,color: Colors.grey),
    labelMedium: TextStyle().copyWith(fontSize: 12,fontWeight: FontWeight.normal,color: Colors.grey),
    labelSmall: TextStyle().copyWith(fontSize: 12,fontWeight: FontWeight.w500,color: Colors.grey),
